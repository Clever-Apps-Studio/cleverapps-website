      ...
      <div class="flex order-2 md:order-1">
        <div class="md:ml-auto">
          ...
          >
            ...
            digital specification sheet. Share your project's key objectives,
            target audience, essential features, design preferences, timeline,
            and budget. Your insights guide us in delivering a solution that not
      ...
      <div class="flex">
        <div class="mr-auto">
          ...
          >
            ...
            collaborating closely with you at this crucial stage, we can create
            a UI/UX that not only meets but exceeds your expectations, resulting
            in a user-centric and visually appealing digital solution. Your
            input is the key to a design that resonates with your audience and
            achieves your project's goals.
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="md:ml-auto">
          ...
          >
            ...
            <span class="font-bold"
              >The initial MVP will be ready in 60 days.</span
            >
          </div>
        </div>
      </div>
